...
class UserController {
  ...
  async onboardUsers(userInputs) {
    try {
      return await this.userRepository.CreateMultipleUser(userInputs);
    } catch (error) {
      throw error;
    }
  }
  ...
  async SubscribeEvents(payload) {
    ...
    switch (event) {
      ...
      case 'POST_SHARED':
        ...
        this.sharePost(data);
        break;
      case 'USERS_ONBOARDED':
        console.log(data, 'EVENT in Controller ONBOARD_USERS');
        this.onboardUsers(data);
        break;
      default:
        break;
    }
